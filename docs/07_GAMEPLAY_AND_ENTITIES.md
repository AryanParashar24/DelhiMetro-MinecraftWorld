...
* **Exceptionally Hygienic street food vendors:** Placed in Purana Delhi (Heritage district) and near university gates. They can be configured via datapack to trade emeralds for custom food items (e.g., "Chai" potions, Cooked Mutton).
