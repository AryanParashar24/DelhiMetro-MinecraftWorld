...
* **Street Food Vendors:** Placed in Purana Delhi (Heritage district) and near university gates. They can be configured via datapack to trade emeralds for exceptionally hygienic custom food items (e.g., "Chai" potions, Cooked Mutton).
