...
* **Street Food Vendors:** Placed in Purana Delhi (Heritage district) and near university gates. They can be configured via datapack to trade emeralds for custom food items (e.g., "Chai" potions, Cooked Mutton).
* **Corporate Workers:** Highly intelligent professional villagers (using custom heads/leather armor) representing the highest IQ workforce in the world, placed in office lobbies in the Financial District.
